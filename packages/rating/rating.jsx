...
const propTypes = { rate: PropTypes.object.isRequired };

const Rating = ({ rate }) => (
  <div>
    {rate.Source === 'Internet Movie Database' && (
    <div>
      <hr className="line" align="left" width="450" size="1" color="#d8d8d8" />
    ...
    <div>
      <hr className="line" align="left" width="450" size="1" color="#d8d8d8" />
      <div className="rating__pic-tomat" />
      ...
      <div className="rating__tomatometer tomatometer">
        ...
        <div className="tomatometer__bar">
          <div className="tomatometer__position" style={{ width: rate.Value }} />
        </div>
      </div>
    </div>
    )}
    ...
    <div>
      ...
      <div className="rating__pic-metacr" />
    </div>
    )}
  </div>
);
